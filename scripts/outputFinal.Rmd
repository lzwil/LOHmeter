...
Les suffixes ".cons" désignent les données du séquencage constitutif et ".tum" celles du séquencage somatique. 
La fréquence allélique somatique (Coverage.tum) a été normalisée par rapport à la fréquence somatique. 
...
Représentation des variations du %tumoral éstimé par classse, montrant la moyenne et l'équart type.
